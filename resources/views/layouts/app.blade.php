...
<head>
    ...
    <title>{{ config('app.name', 'OH Watch Store') }}</title>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ route('index_product') }}">
                    <img src="{{ asset('images/logo.jpeg') }}" alt="Home">
                </a>
                <div class="home-container">
                    <a href="{{ route('index_product') }}" class="home-link">
                    <img src="{{ asset('images/store.svg') }}" alt="Products">
                    </a>
                </div>
